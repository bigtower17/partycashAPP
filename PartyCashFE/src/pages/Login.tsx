...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cyan-500 to-cyan-900">
      <div className="w-max max-w-7xl p-8 flex flex-col lg:flex-row  justify-center space-x-4 bg-white shadow-xl rounded-lg">
        {/* Left side: Logo */}
      ...
      <footer className="flex bottom-4 right-4 text-cyan-900 text-sm">
